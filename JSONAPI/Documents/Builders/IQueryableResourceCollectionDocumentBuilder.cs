...
namespace JSONAPI.Documents.Builders
{
    ...
    public interface IQueryableResourceCollectionDocumentBuilder
    {
        ...
        /// <param name="requestParams">The request containing parameters to determine how to sort/filter/paginate the query</param>
        ...
        /// <returns></returns>
        Task<IResourceCollectionDocument> BuildDocument<T>(IQueryable<T> query, IEnumerable<KeyValuePair<string, string>> requestParams,
            System.Uri requestUri, string[] sortExpressions, CancellationToken cancellationToken,
